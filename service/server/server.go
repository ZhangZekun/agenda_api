...
func initRoutes(mx *mux.Router, formatter *render.Render) {
	...
	//Meeting Hanndler
	mx.HandleFunc("/api/agenda/mneeting", createMeetingHandler(formatter)).Methods("POST")
	...
	mx.HandleFunc("/api/agenda/meeting", queryMeetingHandler(formatter)).Methods("GET")
